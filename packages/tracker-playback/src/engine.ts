...
import {
  type PlaybackPatternStep,
  type ScheduleRowHost,
  clamp,
  scheduleRow,
} from './row-scheduler';
...
export class PlaybackEngine {
  ...
  private scheduleRow(row: number, time: number) {
    scheduleRow.call(this as unknown as ScheduleRowHost, row, time);
  }
