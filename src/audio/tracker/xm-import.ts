 ...
 * `buildXmTrackerPatterns`. What stays here is the sample half: instruments
 * into slots and sampler patches, with XM's envelopes and auto-vibrato mapped
 * onto the app's `Patch`.
 */
