...
// Lives beside the AHX doc (the store rebuilds an AHX song's slots from its file,
// and this module imports the store).
export { buildAhxSlots } from 'src/audio/tracker/ahx-doc/slots';
