(module
 ...
 (type $10 (func (param i32 i32 i32 f32)))
 ...
 (data $10 (i32.const 528) ")\15DNn\83\f9\a2\c0\dd4\f5\d1W\'\fcA\90C<\99\95b\dba\c5\bb\de\abcQ\fe")
 (data $11 (i32.const 560) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\19\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $assembly/synth/fillSine (param $startOffset i32) (param $length i32) (param $frequencyOffset i32) (param $sampleRate f32)
  (local $index i32)
  (local $i i32)
  (local $frequency f32)
  (local $phaseStep f32)
  ...
  loop $for-loop|0
   ...
   i32.lt_s
   if
    local.get $frequencyOffset
    local.get $index
    i32.add
    f32.load
    local.set $frequency
    global.get $assembly/synth/TWO_PI
    local.get $frequency
    f32.mul
    local.get $sampleRate
    f32.div
    local.set $phaseStep
    local.get $startOffset
    local.get $index
    i32.add
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/typedarray/Float32Array $invalid
       end
       return
      end
      return
 ...
 (func $assembly/synth/allocateF32Array (param $length i32) (result i32)
  (local $arr i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
