...
var PORT_LABELS = {
  [0 /* AudioInput0 */]: "Audio Input 1",
  [1 /* AudioInput1 */]: "Audio Input 2",
  [2 /* AudioInput2 */]: "Audio Input 3",
  [3 /* AudioInput3 */]: "Audio Input 4",
  [4 /* AudioOutput0 */]: "Audio Output 1",
  [5 /* AudioOutput1 */]: "Audio Output 2",
  [6 /* AudioOutput2 */]: "Audio Output 3",
  [7 /* AudioOutput3 */]: "Audio Output 4",
  [8 /* GlobalGate */]: "Gate",
  [9 /* GlobalFrequency */]: "Global Frequency",
  [10 /* GlobalVelocity */]: "Global Velocity",
  [11 /* Frequency */]: "Base Frequency",
  [12 /* FrequencyMod */]: "Frequency Mod",
  [13 /* PhaseMod */]: "Phase Mod",
  [14 /* ModIndex */]: "Mod Index",
  [15 /* CutoffMod */]: "Filter Cutoff",
  [16 /* ResonanceMod */]: "Filter Resonance",
  [17 /* GainMod */]: "Gain",
  [18 /* EnvelopeMod */]: "Envelope Amount",
  [19 /* StereoPan */]: "Stereo Panning",
  [20 /* FeedbackMod */]: "Feedback",
  [21 /* DetuneMod */]: "Detune",
  [22 /* WavetableIndex */]: "Wavetable Index",
  [23 /* WetDryMix */]: "Mix",
  [24 /* AttackMod */]: "Attack",
...
var SynthAudioProcessor = class extends AudioWorkletProcessor {
  ...
  handleGetEnvelopePreview(data) {
    ...
    try {
      ...
      this.port.postMessage({
        type: "error",
        source: "getEnvelopePreview",
        message: err instanceof Error ? err.message : "Failed to generate envelope preview",
        messageId: data.messageId,
        instrumentId: data.instrumentId
      });
    }
  ...
  createNodesAndSetupConnections() {
    ...
    const mixerId = this.audioEngines[0].create_mixer();
  ...
  generateReverbImpulse(type, data, secondary) {
    const engines = this.getTargetEngines(data.instrumentId);
    const primary = data.decayTime;
    try {
      for (const engine of engines) {
        const impulse = type === "hall" ? engine.generate_hall_impulse(primary, secondary()) : engine.generate_plate_impulse(primary, secondary());
  ...
  handleUpdateEnvelope(data) {
    ...
    try {
      ...
      this.port.postMessage({
        type: "error",
        source: "updateEnvelope",
        message: err instanceof Error ? err.message : "Failed to update envelope",
        messageId: data.messageId,
        instrumentId: data.instrumentId
      });
    }
